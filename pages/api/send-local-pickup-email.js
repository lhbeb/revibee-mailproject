  ...
  try {
    ...
    const htmlTemplate = `
      ...
      <head>
        ...
        <title>Local Pickup Available - DeelDepot.com</title>
        <style>
              ...
              <table role="presentation" class="container" width="100%" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td style="background-color: #090A28; padding: 24px 32px 40px; text-align: center;">
                    <div style="color: #ffffff; font-size: 16px; font-weight: 500; margin: 0;">Skip shipping and pick up your purchase directly from our warehouse.</div>
                  </td>
                </tr>
                ...
                <tr>
                  <td style="padding: 40px 32px;">
                    <p style="font-size: 16px; color: #374151; margin-bottom: 24px;">
                      ...
                      This product <strong>${productName}</strong> is available for local pickup! Skip shipping and pick up your purchase directly from our warehouse.
                    </p>
                    ...
                    <div style="background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 12px; padding: 24px; margin-bottom: 32px; text-align: center;">
                      <h3 style="font-size: 18px; font-weight: 600; color: #090A28; margin-bottom: 8px;">🚚 Live Far From Our Warehouse?</h3>
                      <p style="color: #475569; font-size: 15px; margin-bottom: 16px;">
                        No problem! You can place your order online and we'll ship it directly to you. We offer fast, free shipping within the U.S. and Canada with our 30-day return policy.
                      </p>
    ...
    const textTemplate = `
      ...
      This product "${productName}" is available for local pickup! Skip shipping and pick up your purchase directly from our warehouse.
      ...
      No problem! Place your order online and we'll ship it directly to you (Fast, free shipping with 30-day returns).
    ...
    const mailOptions = {
      ...
      to: customerEmail,
      subject: `📍 Local Pickup Available for: ${productName}`,
      text: textTemplate,
      html: htmlTemplate,
    };
